...
class CCXSolver(object):
    ...
    def __init__(self, solver_path: str, input_deck_path: str):
        ...
        self.__added_materials = []
        self.__added_element_sets = []

    def add_materials(self, materials):
        self.__added_materials = materials

    def add_element_sets(self, element_sets: List[ElementSet]):
        self.__added_element_sets = element_sets
    ...
    def get_displacement(self):
        ...
        for line in input_deck:
            if "*STEP" in line.upper():
                for material in self.__added_materials:
                ...
                for element_set in self.__added_element_sets:
                ...
                for ii in range(len(self.__added_element_sets)):
                    if len(self.__added_element_sets[ii].get_elements()) <= 0:
                        continue
                    set_name = self.__added_element_sets[ii].get_name()
                    mat_name = self.__added_materials[ii].get_name()
